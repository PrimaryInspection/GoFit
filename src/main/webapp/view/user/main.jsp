    ...
    <div class="container table-bordered">
        ...
        <div class="tab-content table-bordered">
            ...
            <div class="tab-pane active" id="food" role="tabpanel">
                <jsp:include page="/view/user/includeAddFoodBlock.jsp"/>

                <%-------------  SHOW FOOD DIARY  ------------%>
                <c:if test="${not empty meals}">
                    <jsp:include page="/view/user/includeFoodTable.jsp"/>
                </c:if>
            </div>

            <%------------ ACTIVITY ---------------%>
            <div class="tab-pane " id="activity" role="tabpanel">
                <jsp:include page="/view/user/includeAddActivityBlock.jsp"/>

                <%-------------  SHOW ACTIVITY DIARY  ------------%>
                <c:if test="${not empty activitiesList}">
                    <jsp:include page="/view/user/includeActivityTable.jsp"/>
                </c:if>
            </div>

            <%------------- BODY STATS ------------%>
            <div class="tab-pane " id="bodyStats" role="tabpanel">
                <jsp:include page="/view/user/includeAddBodyStatsBlock.jsp"/>
            </div>
        </div>
